...
const channelID = `860019323178188840`
...
const emojiothergame = '<:s_othergame:860432259130851338>';
...
client.on('message', async message => {
    ...
    const yellow = message.guild.roles.cache.find(role => role.id === "861419000068309023")
    const red = message.guild.roles.cache.find(role => role.id === "861419000068309023")
    const green = message.guild.roles.cache.find(role => role.id === "861419000068309023")
    const blue = message.guild.roles.cache.find(role => role.id === "861419000068309023")
    ...
    if (content === "?srcolor") {
        ...
        .setDescription('🔴 - <@&860416313364840488> \n 🟡 - <@&860416255230869544> \n 🟢 - <@&860416471364272138> \n 🔵 - <@&860416495972777994>')
        client.channels.cache.get(`860019323178188840`).send(colorEmbed).then(message => {
        ...
        client.channels.cache.get(`859970300971974686`).send(gameEmbed).then(message => {
            message.react(emojibw)
            message.react(emojisw)
            message.react(emojisb)
            message.react(emojiduel)
            message.react(emojiothergame)
        })
        ...
        client.channels.cache.get(`859970300971974686`).send(genderEmbed).then(message => {
        ...
        client.channels.cache.get(`859970300971974686`).send(pingEmbed).then(message => {
